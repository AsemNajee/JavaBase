...
//            throw an error
    ...
    public ArrayList<RecordedField> getAutoGeneratedKeys(){
        return (ArrayList<RecordedField>) getFields().values().stream().filter(field -> field.getConstraints().contains(Constraints.AUTO_INCREMENT)).collect(Collectors.toList());
    }
